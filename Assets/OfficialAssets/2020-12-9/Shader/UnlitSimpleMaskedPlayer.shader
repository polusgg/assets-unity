			...
			Program "fp" {
				SubProgram "d3d11 " {
					...
					void main()
					{
					    ...
					    u_xlat1 = min(u_xlat0.z, u_xlat0.y);
					    u_xlat1 = min(u_xlat0.x, u_xlat1);
					    ...
					    u_xlat1 = (-u_xlat1) + 1.0;
					    u_xlatb1 = abs(u_xlat1)<0.449999988;
					    u_xlatb1 = u_xlatb1 || u_xlatb3;
					    u_xlat3.xyz = u_xlat0.yyy * _VisorColor.xyz;
					    u_xlat3.xyz = _BodyColor.xyz * u_xlat0.xxx + u_xlat3.xyz;
					    u_xlat3.xyz = _BackColor.xyz * u_xlat0.zzz + u_xlat3.xyz;
					    u_xlat3.xyz = clamp(u_xlat3.xyz, 0.0, 1.0);
					    u_xlat0.xyz = (bool(u_xlatb1)) ? u_xlat0.xyz : u_xlat3.xyz;
